...
require_relative 'discord_rda/entity/channel_builder'
...
require_relative 'discord_rda/event/scheduled_event'
require_relative 'discord_rda/event/auto_moderation'
...
require_relative 'discord_rda/interactions/command_system'
